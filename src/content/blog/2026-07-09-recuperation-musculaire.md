...
tags:
  ...
  - "progression"
faq:
  - question: "Combien de temps faut-il pour récupérer après une séance ?"
    answer: "Un groupe musculaire a généralement besoin de 24 à 72 heures pour récupérer, selon l'intensité de la séance et le niveau du pratiquant. C'est pourquoi on laisse au moins 48 h avant de retravailler lourdement le même muscle. Le sommeil et la nutrition influencent fortement cette durée."
  - question: "Le manque de sommeil nuit-il à la progression ?"
    answer: "Oui, considérablement. Le sommeil est le principal moment de récupération : c'est durant le sommeil profond que la réparation musculaire et la régulation hormonale sont optimales. Un manque chronique de sommeil réduit la récupération, augmente la fatigue et le risque de blessure, et freine la prise de muscle et de force."
  - question: "Les courbatures sont-elles un signe de bonne séance ?"
    answer: "Pas nécessairement. Les courbatures indiquent une sollicitation inhabituelle, mais leur absence ne signifie pas que la séance a été inefficace. On peut très bien progresser sans courbatures. À l'inverse, des courbatures systématiques et intenses peuvent signaler une récupération insuffisante ou une charge mal dosée."
  - question: "Faut-il s'entraîner en cas de courbatures ?"
    answer: "On peut s'entraîner avec de légères courbatures, en adaptant l'intensité ou en travaillant un autre groupe musculaire. En cas de courbatures sévères, mieux vaut privilégier le repos ou une activité légère (marche, mobilité) pour favoriser la récupération. Écoutez votre corps et ne forcez pas sur un muscle très douloureux."
---

On progresse en musculation non pas pendant l'entraînement, mais **pendant la récupération**. L'effort crée le stimulus ; c'est le repos, le sommeil et la nutrition qui transforment ce stimulus en muscle et en force. Pourtant, la **récupération musculaire** reste souvent négligée, au profit d'un volume d'entraînement toujours plus élevé. Ce guide vous explique comment bien récupérer pour maximiser vos résultats et éviter le surentraînement.
...
- **Protéines** (1,6 à 2 g/kg par jour) pour réparer les fibres. Une [[LINK:whey|whey protéine]] peut compléter facilement l'apport post-séance ;
...
La [[LINK:creatine|créatine]] soutient également la récupération sur les efforts intenses et répétés.
...
| --- | --- |
| Sommeil | 7 à 9 h par nuit |
| Repos par muscle | 48 à 72 h |
| Protéines | 1,6 à 2 g/kg/jour |
| Deload | Toutes les 4 à 8 semaines |
...
Un [[LINK:tapis-sol|tapis de sol]] est idéal pour les séances d'étirements et de mobilité à la maison.
